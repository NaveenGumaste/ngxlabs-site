  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute top-1/2 left-1/2 w-[240vw] sm:w-[280vw] md:w-[240vw] lg:w-[210vw] min-w-[900px] sm:min-w-[2000px] md:min-w-[2400px] max-w-[4600px] aspect-[1200/1210] pointer-events-none will-change-transform"
      >
        <Image
